...
use rtc::{
    color::Color,
    transformation::{rotation_x,  rotation_z, scaling, translation, view_transform},
    Camera, Light,  Object, Pattern, PatternType, Point, Vector, World,
};
...
fn main() {
    ...
    let mut camera = Camera::new(1300, 700, PI / 3.0);
    ...
    canvas
        .convert_to_png("pictures/output.png")
        .expect("Error");
}
